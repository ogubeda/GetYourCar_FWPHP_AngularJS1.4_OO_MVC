...
class mail {
    function setEmail($email) {
        ...
        switch ($email['type']) {
            ...
            case 'recover';
                ...
                $content .= "<a href = 'http://192.168.0.182/frameworkCars.v.1.3/#/login/recover/$email[token]'>Click here for recover your password.</a>";
                break;
                //////
            case 'validate';
                $email['fromEmail'] = 'support@getyourcar.com';
                ...
                $content .= "<a href = 'http://192.168.0.182/frameworkCars.v.1.3/#/login/activate/$email[token]'>Click here for verify your email.</a>";
                break;
                //////
        }// end_switch
        //////
    ...
    function sendMailGun($values) {
        $ini_file = parse_ini_file($_SERVER['DOCUMENT_ROOT'] . '/frameworkCars.v.1.3/keys/apis.ini');
        $config = array();
        //////
